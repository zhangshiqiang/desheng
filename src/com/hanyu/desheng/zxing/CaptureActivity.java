package com.hanyu.desheng.zxing;
...
import com.hanyu.desheng.activity.ResAct;
import com.hanyu.desheng.zxing.camera.CameraManager;
import com.hanyu.desheng.zxing.decoding.CaptureActivityHandler;
import com.hanyu.desheng.zxing.decoding.view.ViewfinderView;
...
public final class CaptureActivity extends Activity implements
	...
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
		...
		if (result.contains("desheng4567ds")) {
			...
			intent.putExtra("hx_name", substring);
			setResult(resultCode, intent);
			finish();
		} else if (result.contains("http://")) {
			Intent intent2 = new Intent(CaptureActivity.this, ResAct.class);
			intent2.putExtra("dsurl", result);
			startActivity(intent2);
			finish();
		}else{
			Intent intent3 = new Intent(CaptureActivity.this, ResAct.class);
			intent3.putExtra("result", result);
			startActivity(intent3);
			finish();
		}

		// MyToastUtils.showShortToast(CaptureActivity.this, mobile);
		// Toast.makeText(this,
