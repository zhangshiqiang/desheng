...
public class AllOrderFragment extends BaseFragment {
	...
	public View initView(LayoutInflater inflater) {
		View view = View.inflate(context, R.layout.my_order_lv, null);
		return view;
	}
		...
		new HttpTask<Void, Void, String>(context) {
			...
			protected String doInBackground(Void... params) {
				String miid_id = SharedPreferencesUtil.getStringData(context,
						"memberid", "");
				LogUtil.i(tag, page_no + "");
				String result = EngineManager.getUserEngine().getShopOrder(
						miid_id, "2,4,6", page_no);
//				String result = EngineManager.getUserEngine().getShopOrder(
//						miid_id, "-1,0,2,4,6,8", page_no);
				return result;
