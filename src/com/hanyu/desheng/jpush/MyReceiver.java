package com.hanyu.desheng.jpush;
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
			...
			try {
				...
				String lesson_id = json.optString("lesson");
				String news_id = json.optString("news");
				if (!TextUtils.isEmpty(lesson_id)) {
					Intent i = new Intent(context, LessonDetailsActivity.class);
					i.putExtra("lesson_id", Integer.parseInt(lesson_id.replace("$", "").toString()));
					i.putExtra("flag", 9);
					i.putExtras(bundle);
				...
				if (!TextUtils.isEmpty(news_id)) {
					Intent i = new Intent(context, NewsAct.class);
					i.putExtra("news_id", Integer.parseInt(news_id.replace("$", "").toString()));
					i.putExtra("flag", 9);
					i.putExtras(bundle);
					i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
					context.startActivity(i);
